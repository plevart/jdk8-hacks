...
public class ReflectionTest {
    ...
    static class Test3 extends Thread {
        ...
        public void run() {
            try {
                for (int i = 0; i < loops; i++) {
                    dump(ClassC.class, null, null, NOOP_APPENDABLE);
                }
            }
            catch (IOException e) {}
        }
    ...
    public static void main(String[] args) throws IOException {
        ...
        t = test2(8, 100000, t);
        t = test2(32, 100000, t);
        t = test2(128, 100000, t);
        System.out.println();
        t = test3(1, 10000000, 0);
        t = test3(2, 10000000, t);
        t = test3(4, 10000000, t);
        t = test3(8, 10000000, t);
        t = test3(32, 10000000, t);
        t = test3(128, 10000000, t);
        System.out.println();
    }
}
